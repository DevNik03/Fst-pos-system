...
const itemGroupOverlay = document.querySelector("#item-group-overlay");
const itemGroupPopup = document.querySelector("#item-group-popup");
const itemGroupForm = document.querySelector("#item-group-form");
const itemGroupPopupAdd = document.querySelector("#item-group-open");
const itemGroupPopupClose = document.querySelector("#item-group-close");

function mainPopupEnable() {
  itemGroupPopup.style.visibility = "visible";
  itemGroupPopup.style.opacity = 1;

  itemGroupOverlay.style.visibility = "visible";
  itemGroupOverlay.style.opacity = 1;

  itemGroupForm.scrollTop = 0;
}

function mainPopupDisable() {
  itemGroupPopup.style.visibility = "hidden";
  itemGroupPopup.style.opacity = 0;

  itemGroupOverlay.style.visibility = "hidden";
  itemGroupOverlay.style.opacity = 0;

  itemGroupForm.reset();
  imageInput.value = ""; // Reset file input

  //  image preview is also cleared
  imagePreview.src = "";
  imagePreview.style.display = "none";
}

itemGroupPopupAdd.addEventListener("click", () => {
  mainPopupEnable();
});

itemGroupPopupClose.addEventListener("click", () => {
  mainPopupDisable();
});

itemGroupOverlay.addEventListener("click", () => {
  mainPopupDisable();
});
...
const mainSearchBar = document.querySelector("#item-group-search");
...
function mainSearch() {
  ...
  const tableRows = document.querySelectorAll("#item-group-table tbody tr");
...
document.addEventListener("DOMContentLoaded", () => {
  const table = document.querySelector("#item-group-table");
...
function deleteAllEnable() {
  ...
  const allCheckboxes = document.querySelectorAll(
    "#item-group-table tr input[type='checkbox']"
  );
...
function deleteRecords() {
  const checkedBoxes = document.querySelectorAll(
    "#item-group-table tbody input[type='checkbox']:checked"
  );
...
function noDataDisplay() {
  const rows = document.querySelectorAll("#item-group-table tbody tr");
...
const itemGroupSubmit = document.querySelector("#item-group-submit-button");

itemGroupSubmit.addEventListener("click", () => {
  // Taking inputs
  const itemGroupName = document.querySelector("#item-group-name").value.trim();
  ...
  const existingValues = document.querySelectorAll(
    "#item-group-table tbody tr td:nth-child(2)"
  );
  let isDuplicate = false;

  existingValues.forEach((cell) => {
    if (cell.textContent.trim().toLowerCase() === itemGroupName.toLowerCase()) {
      isDuplicate = true;
    }
  });
  ...
  // Populating the data
  const tableBody = document.querySelector("#item-group-table tbody");
...
document
  .querySelector("#item-group-table tbody")
  .addEventListener("click", (event) => {
