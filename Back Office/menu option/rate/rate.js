...
const popup = document.querySelector(".rate-popup");
const overlay = document.querySelector(".popup-overlay");
const ratePopupForm = document.querySelector("#rate-form");
...
deleteAllCheckbox.addEventListener("change", function () {
  const allCheckboxes = document.querySelectorAll(
    "#rate-table tbody input[type='checkbox']"
  );
...
deletebutton.addEventListener("click", () => {
  tbody = document.querySelector("#rate-table tbody");
  tbody.innerHTML = "";
  checkEmptyTable();
});
...
const searchBar = document.querySelector("#rate-search");
...
submitButton.addEventListener("click", (event) => {
  ...
  let newValue = rateName.toLowerCase();
  ...
  const tableBody = document.querySelector("#rate-table tbody");
...
document
  .querySelector("#rate-table tbody")
