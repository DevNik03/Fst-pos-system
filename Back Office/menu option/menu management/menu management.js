...
const menuManagementOverlay = document.querySelector(
  "#menu-management-overlay"
);
const menuManagementPopup = document.querySelector("#menu-management-popup");
const menuManagementForm = document.querySelector("#menu-management-form");
const menuManagementPopupAdd = document.querySelector("#menu-management-open");
const menuManagementPopupClose = document.querySelector(
  "#menu-management-close"
);

function mainPopupEnable() {
  menuManagementPopup.style.visibility = "visible";
  menuManagementPopup.style.opacity = 1;

  menuManagementOverlay.style.visibility = "visible";
  menuManagementOverlay.style.opacity = 1;

  menuManagementForm.scrollTop = 0;
}

function mainPopupDisable() {
  menuManagementPopup.style.visibility = "hidden";
  menuManagementPopup.style.opacity = 0;

  menuManagementOverlay.style.visibility = "hidden";
  menuManagementOverlay.style.opacity = 0;

  menuManagementForm.reset();
}

menuManagementPopupAdd.addEventListener("click", () => {
  mainPopupEnable();
});

menuManagementPopupClose.addEventListener("click", () => {
  mainPopupDisable();
});

menuManagementOverlay.addEventListener("click", () => {
  mainPopupDisable();
});
...
const mainSearchBar = document.querySelector("#menu-management-search");
...
document.addEventListener("DOMContentLoaded", () => {
  const table = document.querySelector("#menu-management-table");
...
function deleteAllEnable() {
  ...
  const allCheckboxes = document.querySelectorAll(
    "#menu-management-table tr input[type='checkbox']"
  );
...
function deleteRecords() {
  const checkedBoxes = document.querySelectorAll(
    "#menu-management-table tbody input[type='checkbox']:checked"
  );
...
function noDataDisplay() {
  const rows = document.querySelectorAll("#menu-management-table tbody tr");
...
const menuManagementSubmit = document.querySelector(
  "#menu-management-submit-button"
);

menuManagementSubmit.addEventListener("click", () => {
  // Taking inputs
  ...
  let isDuplicate = Array.from(existingValues).some(
    (cell) => cell.textContent.trim().toLowerCase() === menuName.toLowerCase()
  );
