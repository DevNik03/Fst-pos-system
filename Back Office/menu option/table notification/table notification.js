...
const popup = document.querySelector(".table-notification-popup");
...
deleteAllCheckbox.addEventListener("change", function () {
  const allCheckboxes = document.querySelectorAll(
    "#table-notification-table tbody input[type='checkbox']"
  );
...
deletebutton.addEventListener("click", () => {
  tbody = document.querySelector("#table-notification-table tbody");
  tbody.innerHTML = "";
  checkEmptyTable();
});
...
const searchBar = document.querySelector("#table-notification-search");
...
const submitButton = document.querySelector("#table-notification-submit");
submitButton.addEventListener("click", (event) => {
  event.preventDefault();

  const notificationName = document
    .querySelector("#notification-name")
    .value.trim();

  const iconSelect = document.querySelector("#notification-icon");
  ...
  let newValue = notificationName.toLowerCase();
