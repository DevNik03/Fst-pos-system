...
const tableNotificationOverlay = document.querySelector(
  "#table-notification-overlay"
);
const tableNotificationPopup = document.querySelector(
  "#table-notification-popup"
);
const tableNotificationForm = document.querySelector(
  "#table-notification-form"
);
const tableNotificationPopupAdd = document.querySelector(
  "#table-notification-open"
);
const tableNotificationPopupClose = document.querySelector(
  "#table-notification-close"
);

function mainPopupEnable() {
  tableNotificationPopup.style.visibility = "visible";
  tableNotificationPopup.style.opacity = 1;

  tableNotificationOverlay.style.visibility = "visible";
  tableNotificationOverlay.style.opacity = 1;

  tableNotificationForm.scrollTop = 0;
}

function mainPopupDisable() {
  tableNotificationPopup.style.visibility = "hidden";
  tableNotificationPopup.style.opacity = 0;

  tableNotificationOverlay.style.visibility = "hidden";
  tableNotificationOverlay.style.opacity = 0;

  sessionForm.reset();
}

tableNotificationPopupAdd.addEventListener("click", () => {
  mainPopupEnable();
});

tableNotificationPopupClose.addEventListener("click", () => {
  mainPopupDisable();
});

tableNotificationOverlay.addEventListener("click", () => {
  mainPopupDisable();
});
...
const mainSearchBar = document.querySelector("#table-notification-search");
...
document.addEventListener("DOMContentLoaded", () => {
  const table = document.querySelector("#table-notification-table");
...
function deleteAllEnable() {
  ...
  const allCheckboxes = document.querySelectorAll(
    "#table-notification-table tr input[type='checkbox']"
  );
...
function deleteRecords() {
  const checkedBoxes = document.querySelectorAll(
    "#table-notification-table tbody input[type='checkbox']:checked"
  );
...
function noDataDisplay() {
  const rows = document.querySelectorAll("#table-notification-table tbody tr");
...
const tableNotificationSubmit = document.querySelector(
  "#table-notification-submit-button"
);

tableNotificationSubmit.addEventListener("click", () => {
  // Taking inputs
  const notificationName = document.querySelector("#notification-name").value;

  const notificationIcon = document.querySelector("#notification-icon").value;
  ...
  if (notificationIcon === "" || notificationIcon === "default") {
  ...
  const existingValues = document.querySelectorAll(
    "#table-notification-table tbody tr td:nth-child(2)"
  );

  let isDuplicate = Array.from(existingValues).some(
    (cell) =>
      cell.textContent.trim().toLowerCase() === notificationName.toLowerCase()
  );
  ...
  // Populating the data
  const tableBody = document.querySelector("#table-notification-table tbody");
...
document
  .querySelector("#table-notification-table tbody")
  .addEventListener("click", (event) => {
