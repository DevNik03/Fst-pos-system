...
const TCOverlay = document.querySelector("#template-category-overlay");
const TCPopup = document.querySelector("#template-category-popup");
const TCForm = document.querySelector("#template-category-form");
const TCPopupAdd = document.querySelector("#template-category-open");
const TCPopupClose = document.querySelector("#template-category-close");
...
document.addEventListener("DOMContentLoaded", () => {
  const table = document.querySelector("#template-category-table");
...
function deleteAllEnable() {
  ...
  const allCheckboxes = document.querySelectorAll(
    "#template-category-table tr input[type='checkbox']"
  );
...
function deleteRecords() {
  const checkedBoxes = document.querySelectorAll(
    "#template-category-table tbody input[type='checkbox']:checked"
  );
...
function noDataDisplay() {
  const rows = document.querySelectorAll("#template-category-table tbody tr");
...
const templateCategorySubmit = document.querySelector(
  "#template-category-submit-button"
);

templateCategorySubmit.addEventListener("click", () => {
  // Taking inputs

  const Name = document.querySelector("#template-category-name").value.trim();
