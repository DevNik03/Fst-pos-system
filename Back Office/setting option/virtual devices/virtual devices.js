...
const popup = document.querySelector(".virtual-devices-popup");
const overlay = document.querySelector(".popup-overlay");
const waiterForm = document.querySelector("#virtual-devices-popup-form ");
...
const selectType = document.querySelector("#device-type");
const deviceType = [
  "KOT Printer",
  "Reciept Printer",
  "Fiscal Printer",
...
deleteAllCheckbox.addEventListener("change", function () {
  const allCheckboxes = document.querySelectorAll(
    "#virtual-devices-table tbody input[type='checkbox']"
  );
...
deletebutton.addEventListener("click", () => {
  tbody = document.querySelector("#virtual-devices-table tbody");
  tbody.innerHTML = "";
  checkEmptyTable();
});
...
const searchBar = document.querySelector("#virtual-device-search");
...
const submitButton = document.querySelector("#virtual-device-submit");
submitButton.addEventListener("click", (event) => {
  ...
  let newValue = deviceName.toLowerCase();
  let existingValues = document.querySelectorAll(
    "#virtual-devices-table tbody tr td:nth-child(2)"
  );
  ...
  // Populating table
  const tableBody = document.querySelector("#virtual-devices-table tbody");
...
document
  .querySelector("#virtual-devices-table tbody")
