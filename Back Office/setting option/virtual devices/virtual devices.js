...
//populating the device select

const deviceTypes = [
  "KOT Printer",
  "Reciept Printer",
  "Fiscal Printer",
  "Online Fiscal Interface",
  "Cash Drawer",
  "Mini Report Printer",
  "Customer Display",
  "Captain Printer",
...
const deviceTypeSelect = document.querySelector("#device-type");
...
const mainSearchBar = document.querySelector("#VD-search");
...
function mainSearch() {
  ...
  const tableRows = document.querySelectorAll("#VD-table tbody tr");
...
document.addEventListener("DOMContentLoaded", () => {
  const table = document.querySelector("#VD-table");
...
function deleteAllEnable() {
  ...
  const allCheckboxes = document.querySelectorAll(
    "#VD-table tr input[type='checkbox']"
  );
...
function deleteRecords() {
  const checkedBoxes = document.querySelectorAll(
    "#VD-table tbody input[type='checkbox']:checked"
  );
...
function noDataDisplay() {
  const rows = document.querySelectorAll("#VD-table tbody tr");
...
document.querySelector("#VD-table tbody").addEventListener("click", (event) => {
...
function recordCount() {
  const rowLength = document.querySelectorAll("#VD-table tbody tr").length;
