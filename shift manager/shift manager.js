...
document.getElementById("btn-image-2").addEventListener("click", function() {
  window.location.href = "shift manager 2.html";
});

//// POPUP START SHIFT ////
document.addEventListener("DOMContentLoaded", function () {
  const modal = document.getElementById("popup-modal");
  const openBtns = document.querySelectorAll(".start-shift");
  const closeBtn = document.querySelector(".close-btn");

  // Open modal when clicking any start-shift button
